...
public class Main {
    public static void main(String[] args) {
        ...
        if (pathSalvo != null && Files.exists(pathSalvo)) {
            ...
            biblioteca = new Biblioteca("Biblioteca Padrão", pathSalvo);
        } else {
            ...
            try {
                ...
                biblioteca = new Biblioteca("Biblioteca Padrão", pathNovo);
            } catch (Exception e) {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Informe o título da entrada a remover:");
                    ...
                    break;
                case 4:
                    System.out.println("Informe o título da entrada a editar:");
